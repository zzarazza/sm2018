<?php
/**
 * Systemorph 2018: Color Patterns
 *
 * @package WordPress
 ...
 */
function systemorph_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Systemorph 2018 default saturation level.
	 *
	 * @since Systemorph 2018 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'systemorph_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.systemorph-front-page) .entry-title,
...
.colors-custom .systemorph-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.systemorph-front-page .panel-content .recent-posts article,
...
.colors-custom.systemorph-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Systemorph 2018 custom colors CSS.
	 *
	 * @since Systemorph 2018 1.0
	 *
	 ...
	 */
	return apply_filters( 'systemorph_custom_colors_css', $css, $hue, $saturation );
}
